...
def compare(request):
    try :
        if request.method == "POST":
            ...
            applicationKey = "The key from one of your Verification Apps, found here https://dashboard.sinch.com/verification/apps"
            applicationSecret = "The secret from the Verification App that uses the key above, found here https://dashboard.sinch.com/verification/apps"
